...
import com.martin.kmpsword.versification.BibleNames
...
object SwordConstants {
     ...
     */
    const val FILE_NT: String = "nt" //$NON-NLS-1$

    /**
     * Old testament data files
     */
    const val FILE_OT: String = "ot" //$NON-NLS-1$

    /**
     * Index file extensions
     */
    const val EXTENSION_VSS: String = ".vss" //$NON-NLS-1$

    /**
     * Extension for index files
     */
    const val EXTENSION_INDEX: String = ".idx" //$NON-NLS-1$

    /**
     * Extension for data files
     */
    const val EXTENSION_DATA: String = ".dat" //$NON-NLS-1$

    /**
     * Extension for config files
     */
    const val EXTENSION_CONF: String = ".conf" //$NON-NLS-1$

    /**
     * The data directory
     */
    const val DIR_DATA: String = "modules" //$NON-NLS-1$

    /**
     * The configuration directory
     */
    const val DIR_CONF: String = "mods.d" //$NON-NLS-1$

    /**
     * constant for the introduction
     */
    const val TESTAMENT_INTRO: Int = 0

    /**
     * constant for the old testament
     */
    const val TESTAMENT_OLD: Int = 1

    /**
     * constant for the new testament
     */
    const val TESTAMENT_NEW: Int = 2

    /**
     * Get the testament of a given verse
     */
    fun getTestament(v: Verse): Int {
//        val ord: Int = v.getOrdinal()
//
//        if (ord >= ORDINAL_MAT11) {
//            // This is an NT verse
//            return TESTAMENT_NEW
//        }
        // This is an OT verse
        return TESTAMENT_OLD
    }

    /**
     * Get the sword index of the given verse
     */
    fun getIndex(v: Verse): Int {
        var book: Int = v.book
        val chapter: Int = v.chapter
        val verse: Int = v.verse
        var testament = getTestament(v)

        if (testament == TESTAMENT_NEW) {
            book -= BibleNames.MALACHI
        }

        val bookOffset = bks[testament]!![book]
        val chapOffset = cps[testament]!![bookOffset + chapter]
     ...
     */
//    val ORDINAL_MAT11: Int = Verse(BibleNames.MATTHEW.toInt(), 1, 1, true).getOrdinal()

    /**
     * array containing LUT of offsets in the chapter table.
     */
    private var bks = arrayOfNulls<ShortArray>(3)
     ...
     */
    private var cps = arrayOfNulls<ShortArray>(3)
    ...
    init {
        ...
        bks[TESTAMENT_OLD] = bksot
        bks[TESTAMENT_NEW] = bksnt

        val cpsot = shortArrayOf(
            0,
            2,
            3,
            35,
        ...
        cps[TESTAMENT_OLD] = cpsot
        cps[TESTAMENT_NEW] = cpsnt
    }
}
